...
<div class="container mt-5">
    <div class="card card-profile p-4 mx-auto" style="max-width: 500px;">
        ...
        <?php else: ?>
        <div class="text-center mb-3">
            <img src="/image/default_profile.jpg" alt="Default Profile Picture" class="rounded-circle" width="150"
                height="150" style="object-fit: cover; opacity: 0.7;">
        </div>
        <?php endif; ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="gender" name="gender">
                            ...
                            <option value="prefer_not_to_say"
                                <?= ($user['gender'] ?? '') === 'prefer_not_to_say' ? 'selected' : '' ?>>Prefer not to
                                say</option>
                        </select>
                    </div>
                    <div class="mb-3">
