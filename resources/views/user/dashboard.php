    ...
    <div class="content">
        <div class="container mt-4">
            ...
            <div class="alert alert-info">
                Welcome! Start by creating your first trip.
            </div>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            ...
                            <a href="/trip/<?= $trip['id'] ?>/itinerary" class="btn btn-success btn-sm me-2">Trip
                                Itinerary</a>
                            <a href="/user/trip/<?= $trip['id']; ?>/invitation/send"
                                class="btn btn-primary btn-sm me-2">Send Invitation</a>
...
// SweetAlert Handling for success
    ...
    echo "<script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                ...
                window.location.href = '/user/dashboard'; // Redirect after error
            });
        });
    </script>";
