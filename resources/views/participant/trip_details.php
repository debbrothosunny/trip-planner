                        ...
                        <?php if (!empty($accommodations)) : ?>
                            <?php foreach ($accommodations as $accommodation): ?>
                                <div class="border-bottom pb-2 mb-2">
                                    ...
                                    <small>Check-in: <?= htmlspecialchars($accommodation['check_in_time']) ?> | Check-out: <?= htmlspecialchars($accommodation['check_out_time']) ?></small>
                        ...
                        <?php if (!empty($transportation)) : ?>
                            <?php foreach ($transportation as $transport): ?>
                                <div class="border-bottom pb-2 mb-2">
                                    ...
                                    <p class="text-muted">Departure: <?= htmlspecialchars($transport['departure_location']) ?> | Arrival: <?= htmlspecialchars($transport['arrival_location']) ?> | Comapny Name: <?= htmlspecialchars($transport['company_name']) ?>| Departure Date: <?= htmlspecialchars($transport['departure_date']) ?>| Arrival Date: <?= htmlspecialchars($transport['arrival_date']) ?>| Amount: $<?= htmlspecialchars($transport['amount']) ?></p>
                                </div>
                            <?php endforeach; ?>
                        <?php else : ?>
